...
export default function Contact({
  ...
  return (
    <SectionStatic id="contact" containerClassName="py-16 md:py-24" ariaLabelledBy="contact-heading">
      <div
        className="mb-10 h-px w-full bg-gradient-to-r from-transparent via-white/10 to-transparent"
        aria-hidden="true"
      />
      <div className="mx-auto max-w-[60ch] text-center">
        <p className="text-[11px] uppercase tracking-[0.3em] text-white/45 md:text-xs">
          {sectionTag}
        </p>
        <h2
          id="contact-heading"
        ...
        <p className="mt-4 text-sm text-white/70 leading-7 md:text-base">
          {subline}
        </p>
